using System;
using Cobilas.IO.Alf;
using System.Globalization;
using System.Runtime.Serialization;

namespace Cobilas.IO.Alf.Alfbt {
    [Serializable]
    public class ALFBTFormatException : ALFException {
        ...
        internal static ALFBTFormatException GetInvalidFormattingException(int line, string txt)
            => GetException(
                $"(Line: {line})({txt})\r\nFlag formatting invalid!",
                $"(Linha: {line})({txt})\r\nFormatação de bandeira invalida!"
                );
